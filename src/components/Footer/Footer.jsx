...
function Footer() {
  return (
    <footer className="relative w-full bottom-0 overflow-hidden bg-white py-2 lg:py-4">
      <div className="lg:container relative z-10 mx-auto lg:px-4">
          ...
          <div className="w-auto py-0 px-4 lg:p-8">
            <div className="-m-1.5 flex flex-wrap">
              <div className="w-auto p-1.5">
                <a href="https://www.linkedin.com/in/naman-khandelwal-568971189/" target="_blank">
              ...
              <div className="w-auto p-1.5">
                <a href="https://twitter.com/NAMANKH31936926" target="_blank">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                    <svg
                      width="14"
                      height="11"
              ...
              <div className="w-auto p-1.5">
                <a href="https://www.instagram.com/naman_koolwal/" target="_blank">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                    <svg
                      width="16"
                      height="15"
        ...
        <div className="mt-4 text-gray-500 text-center text-[10px] md:text-xs">
        <p>© {new Date().getFullYear()} MegaBlog. All rights reserved. Made By Naman with ❤</p>
      </div>
      </div>
    </footer>
  );
